...
interface Balanza13Definition
{
    ...
    public const XSD_LOCATION = 'http://www.sat.gob.mx/esquemas/ContabilidadE'
        . '/1_3/BalanzaComprobacion/BalanzaComprobacion_1_3.xsd';

    public const XSLT_LOCATION = 'https://www.sat.gob.mx/esquemas/ContabilidadE'
        . '/1_3/BalanzaComprobacion/BalanzaComprobacion_1_2.xslt';
